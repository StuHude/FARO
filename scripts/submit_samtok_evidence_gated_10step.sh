...
export FARO_ROOT
export CONFIG=${CONFIG:-$FARO_ROOT/Sa2VA/projects/samtok_selective/configs/fepo_evidence_gated_10step_2gpu.py}
export SAMTOK_SELECTIVE_DATA=${SAMTOK_SELECTIVE_DATA:-$FARO_ROOT/data/fepo_existence/egfepo_train_5120.jsonl}
export JOB_NAME=${JOB_NAME:-dna-samtok-evidence-gated-10step-2g}
