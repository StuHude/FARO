#!/usr/bin/env bash
set -euo pipefail
OUT_DIR="/mnt/pfs/xiaoyicheng/outputs/pixvl_idea3/semcovcal_routed_opd_rl_8gpu_500_run2"
...
while true; do
  now=$(date '+%F %T %Z')
  echo "===== $now =====" >> "$LOG"
  ps -eo pid,etimes,pcpu,pmem,stat,cmd | rg 'joint_routed_opd_rl_trainer|idea3_semcovcal_routed_opd_rl_8gpu_500_run2|idea3_semcovcal_routed_opd_rl_8gpu_500' >> "$LOG" || true
...
import json
p='/mnt/pfs/xiaoyicheng/outputs/pixvl_idea3/semcovcal_routed_opd_rl_8gpu_500_run2/metrics.partial.json'
