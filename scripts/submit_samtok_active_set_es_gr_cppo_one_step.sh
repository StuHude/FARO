...
CONFIG=${CONFIG:-$FARO_ROOT/Sa2VA/projects/samtok_selective/configs/fepo_active_set_es_gr_cppo_one_step_2gpu.py}
ADAPTER=${SAMTOK_STANDALONE_ADAPTER:-$FARO_ROOT/outputs/samtok_selective/continued_sft_to500/adapter}
JOB_NAME=${JOB_NAME:-dna-samtok-fepo-active-set-es-one-step-2g}
...
python3 -m projects.samtok_selective.active_set_gr_cppo_contract \
