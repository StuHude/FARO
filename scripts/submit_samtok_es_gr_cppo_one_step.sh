...
CONFIG=${CONFIG:-$FARO_ROOT/Sa2VA/projects/samtok_selective/configs/fepo_entropy_gr_cppo_one_step_2gpu.py}
ADAPTER=${SAMTOK_STANDALONE_ADAPTER:-$FARO_ROOT/outputs/samtok_selective/continued_sft_to500/adapter}
JOB_NAME=${JOB_NAME:-dna-samtok-fepo-es-gr-cppo-one-step-2g}
...
export SAMTOK_SELECTIVE_DATA='$DATA'
export SAMTOK_STANDALONE_ADAPTER='$ADAPTER'
export FEPO_EVIDENCE_MODE='$FEPO_EVIDENCE_MODE'
