...
JOB_NAME=${JOB_NAME:-dna-fepo-rollout-smoke-r2}
...
echo FEPO_ROLLOUT_START | tee '$FARO_ROOT/logs/$JOB_NAME.log'
...
print('FEPO_ROLLOUT_OK', {'cuda': torch.cuda.get_device_name(0), 'text': text, 'route': route}, flush=True)
PY
"
