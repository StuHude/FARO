...
from projects.samtok_selective.tail_gppo_contract import UNIFIED_PLAIN_STAGE


config = copy.deepcopy(build_tail_gppo_config("plain_rank", 10))
config["stage"] = UNIFIED_PLAIN_STAGE
...
config["checkpoint"]["output_dir"] = str(
    Path(config["checkpoint"]["output_dir"]).with_name(UNIFIED_PLAIN_STAGE)
)
