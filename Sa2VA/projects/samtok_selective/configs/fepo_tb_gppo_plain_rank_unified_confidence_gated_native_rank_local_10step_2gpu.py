"""R27: hard confidence-gated native rank-local geometry credit."""
...
config["seed"] = 17
config["stage"] = UNIFIED_CONFIDENCE_GATED_NATIVE_RANK_LOCAL_STAGE
...
config["tail_gppo"].update(
    {
        ...
        "advantage": "native_reference_confidence_gated_mean_normalized",
        "pareto_credit_mode": "confidence_gated_native_rank_local",
        "depth_local_credit_policy": "native_reference_confidence_gate_first_divergence",
