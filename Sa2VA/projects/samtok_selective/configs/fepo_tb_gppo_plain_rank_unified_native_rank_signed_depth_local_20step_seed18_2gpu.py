"""R33: seed-18 replication of persistent signed native-rank FEPO."""

import copy
from pathlib import Path

from projects.samtok_selective.configs.tail_gppo_common import build_tail_gppo_config
from projects.samtok_selective.tail_gppo_contract import UNIFIED_NATIVE_RANK_SIGNED_20_SEED18_STAGE


config = copy.deepcopy(build_tail_gppo_config("plain_rank", 20))
config["seed"] = 18
config["stage"] = UNIFIED_NATIVE_RANK_SIGNED_20_SEED18_STAGE
...
config["checkpoint"]["output_dir"] = str(
    Path(config["checkpoint"]["output_dir"]).with_name(UNIFIED_NATIVE_RANK_SIGNED_20_SEED18_STAGE)
)
...
config["tail_gppo"].update(
    {
        ...
        "pareto_credit_mode": "native_rank_signed_depth_local",
        "depth_local_credit_policy": "native_reference_signed_rank_first_divergence",
