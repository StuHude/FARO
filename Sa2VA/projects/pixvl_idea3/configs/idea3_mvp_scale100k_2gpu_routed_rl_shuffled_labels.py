...
config["stage"] = "idea3_mvp_scale100k_2gpu_routed_rl_shuffled_labels"
config["run_name"] = "idea3_mvp_scale100k_2gpu_routed_rl_shuffled_labels"
config["checkpoint"]["output_dir"] = "/mnt/pfs/xiaoyicheng/outputs/pixvl_idea3/scale100k_2gpu_routed_rl_shuffled_labels"
...
# 2 GPUs * batch 5 * 10000 steps = 100k exposure
