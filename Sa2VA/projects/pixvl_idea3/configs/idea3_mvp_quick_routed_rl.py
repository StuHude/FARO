...
config["stage"] = "idea3_mvp_quick_routed_rl"
config["run_name"] = "idea3_mvp_quick_routed_rl"
config["checkpoint"]["output_dir"] = "/mnt/pfs/xiaoyicheng/outputs/pixvl_idea3/quick_routed_rl"
