...
config["stage"] = "fepo_long_shuffled_6gpu"
config["run_name"] = "fepo_long_shuffled_6gpu"
config["routing"]["mode"] = "shuffled"
config["optimizer"]["max_steps"] = 100
config["checkpoint"]["save_every"] = 50
config["checkpoint"]["output_dir"] = str(Path(config["paths"]["output_root"]) / "fepo_long_shuffled_6gpu")
