...
config["stage"] = "idea3_atom_triage_noevidence_routed_opd_rl_8gpu_100_from_autoroute200"
config["run_name"] = "idea3_atom_triage_noevidence_routed_opd_rl_8gpu_100_from_autoroute200"
config["checkpoint"]["output_dir"] = str(
    ROOT / "outputs" / "pixvl_idea3" / "atom_triage_noevidence_routed_opd_rl_8gpu_100_from_autoroute200"
)

config["student_init"] = {
    "adapter_path": "/mnt/pfs/xiaoyicheng/outputs/pixvl_idea3/atom_semcovcal_routed_opd_rl_8gpu_100_from_ckpt1000_mix55_calprompt/checkpoint-step-200/adapter",
}
