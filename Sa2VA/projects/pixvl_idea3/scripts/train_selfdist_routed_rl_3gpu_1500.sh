...
MASTER_PORT="${MAIN_PROCESS_PORT:-29582}"
CONFIG_PATH="$REPO_ROOT/projects/pixvl_idea3/configs/idea3_mvp_scale100k_3gpu_routed_rl_selfdist1500.py"
LOG_DIR="${LOG_DIR:-/mnt/pfs/xiaoyicheng/outputs/pixvl_idea3/scale100k_3gpu_routed_rl_selfdist1500/manual_logs}"
mkdir -p "$LOG_DIR"
PIDS=()
